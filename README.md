...
工作、学业、人际压力让人孤独，但用日常 AI 谈心事总觉别扭、放不开。SoulMate AI 完全离线，不上传、不追踪，秘密只留本地。它会记住、会回应，只做一件事：你的专属树洞。放心倾诉，没有评判，没有外界。
# SoulMate AI
...
SoulMate AI 是一个完全本地运行、保护隐私的 AI 伴侣。它使用 Ollama 在本地运行大语言模型（qwen2:1.5b），所有数据都保存在你自己的电脑上。无需 API Key，无需联网，无追踪。
